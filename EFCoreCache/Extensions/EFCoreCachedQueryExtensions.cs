...
public static class EFCoreCachedQueryExtensions
{
    ...
    public static readonly string IsNotCachableMarker =
        $"{nameof(EFCoreCacheInterceptor)}{nameof(NotCacheable)}";
    ...
    {
        SanityCheck(query);
        return query.TagWith(EFCoreCachePolicy.Configure(options =>
