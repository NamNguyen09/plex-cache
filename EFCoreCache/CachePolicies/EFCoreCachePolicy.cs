...
public class EFCoreCachePolicy
{
    /// <summary>
    ///     It's `|`
    /// </summary>
    ...
    ///     This array will be used to invalidate the related cache of all related queries automatically.
    /// </summary>
    public EFCoreCachePolicy CacheDependencies(params string[] cacheDependencies)
    {
    ...
    ///     Its default value is Absolute.
    /// </summary>
    public EFCoreCachePolicy ExpirationMode(CacheExpirationMode expirationMode)
    {
    ...
    ///     Its default value is 20 minutes later.
    /// </summary>
    public EFCoreCachePolicy Timeout(TimeSpan timeout)
    {
    ...
    ///     Its default value is string.Empty.
    /// </summary>
    public EFCoreCachePolicy SaltKey(string saltKey)
    {
    ...
    ///     Determines the default Cacheable method
    /// </summary>
    public EFCoreCachePolicy DefaultCacheableMethod(bool state)
    {
    ...
    /// </summary>
    public static string Configure(Action<EFCoreCachePolicy> options)
    {
        if (options == null)
        {
        ...
        var cachePolicy = new EFCoreCachePolicy();
    ...
    public override string ToString() =>
        $"{nameof(EFCoreCachePolicy)} {PartsSeparator} {CacheExpirationMode}{ItemsSeparator}{CacheTimeout}{ItemsSeparator}{CacheSaltKey}{ItemsSeparator}{string.Join(CacheDependenciesSeparator, CacheItemsDependencies)}{ItemsSeparator}{IsDefaultCacheableMethod}"
