...
/// </summary>
public class EFCoreDataReaderLoader : DbDataReader
{
    private readonly DbDataReader _dbReader;
    private readonly EFCoreTableRows _tableRows;
    ...
    ///     Converts a DbDataReader to an EFTableRows
    /// </summary>
    public EFCoreDataReaderLoader(DbDataReader dbReader)
    {
        _dbReader = dbReader;
        _tableRows = new EFCoreTableRows(_dbReader)
        {
    ...
    public override bool Read()
    {
        ...
        _tableRows?.Add(new EFCoreTableRow(_rowValues)
        {
    ...
    ///     Converts a DbDataReader to an EFTableRows
    /// </summary>
    public EFCoreTableRows LoadAndClose()
    {
        while (Read())
        {
            // Read all data
